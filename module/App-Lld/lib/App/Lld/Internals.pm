...
App::Lld::Internals - The great new App::Lld::Internals!
...
Perhaps a little code snippet.
    ...
    use App::Lld::Internals;

    my $foo = App::Lld::Internals->new();
    ...
